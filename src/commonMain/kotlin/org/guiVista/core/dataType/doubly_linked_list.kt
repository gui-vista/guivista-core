...
expect class DoublyLinkedList : Closable {
    ...
    val first: DoublyLinkedList?

    /** Fetches the last element in this list. */
    val last: DoublyLinkedList?
     ...
     */
    fun position(listLink: DoublyLinkedList): Int
     ...
     */
    fun removeLink(link: DoublyLinkedList)
     ...
     */
    fun deleteLink(link: DoublyLinkedList)
     ...
     */
    fun concat(list: DoublyLinkedList)
     ...
     */
    fun elementAt(pos: UInt): DoublyLinkedList?
}
